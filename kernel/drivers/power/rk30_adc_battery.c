...
static struct batt_vol_cal  batt_table[] = {
	{ 0,3520,3710},{ 5,3548,3722},{ 10,3572,3744},{20,3604,3776},
	{30,3625,3796},{40,3661,3828},{ 50,3709,3877},{60,3771,3936},
	{70,3830,3990},{80,3900,4060},{ 90,3990,4140},{95,4050,4180},
	{100,4120,4200}
/*
...
{		
	...
	switch (psp) {
		...
		case POWER_SUPPLY_PROP_VOLTAGE_NOW:
			val ->intval = rk30_adc_battery_get_voltage(gBatteryData)*1000;
			DBG("gBatVoltage=%d\n",val->intval);
			break;
