...
#define SENSOR_NAME CONS(RK29_CAM_SENSOR_SP2035,_mr13)
#define SENSOR_V4L2_IDENT  V4L2_IDENT_GC2035
#define SENSOR_ID 0x2035
#define SENSOR_MIN_WIDTH    800//640
#define SENSOR_MIN_HEIGHT   600//480
...
static struct reginfo sensor_init_data[] ={
	...
	{0x17,0x14}, //[0]mirror [1]flip  17  14
...
/////banding///////
	...
	{0xfe,0x03},
	{0x42,0x80}, 
	{0x43,0x06}, //output buf width //buf width��һ�������û���Ҫ������
	{0x41,0x02}, // delay
	{0x40,0x00}, //fifo half full trig
	{0x17,0x01}, //wid mipi���ֵķ�Ƶ��Ϊʲôv��
	{0xfe,0x00},
...
{0x4f,0x01},         
	...
	{0x39,0x30},  //50asde_autogray_threshold  0x50     0x30
	...
	{0x84,0x45},//RB offset
	{0xd1,0x38},  //saturation_cb  0x38
	{0xd2,0x38},  //saturation_Cr  0x38
	{0xd3,0x3c},	// contrast 0x40
	{0xdc,0x30},
	...
	{0x38,0x0f},  //asde_autogray_slope 0x08   0x0f
	{0x39,0x40},  //asde_autogray_threshold  0x60
	{0xfe,0x00},
...
static int sensor_init(struct v4l2_subdev *sd, u32 val)
{
    ...
    if(strstr(dev_name(icd->pdev),"front"))
    {
        printk("gc2035 front\n");
        sensor_write(client, 0x24, 0x1A);
    }
	sensor_task_lock(client,0);
    msleep(1000);
...
static int sensor_s_fmt(struct v4l2_subdev *sd, struct v4l2_mbus_framefmt *mf)
{
    ...
    if ((int)winseqe_set_addr  != sensor->info_priv.winseqe_cur_addr) {
		...
		printk("set_w===%d,set_h=====%d",set_w,set_h);
#if 1
		...
		if ((winseqe_set_addr ==sensor_svga)||(winseqe_set_addr == sensor_vga)){
			...
			sensor_write(client, 0xb6, 0x03);  // AEC ON
			mdelay(300);
                    } 
		#endif
#endif 
