...
#define SENSOR_NAME 	RK29_CAM_SENSOR_SP2035
...
{0x4f,0x01},         
	...
	{0x84,0x45},//RB offset
	{0xd1,0x40},  //saturation_cb  0x38
	{0xd2,0x40},  //saturation_Cr  0x38
	...
	{0x38,0x0a},  //asde_autogray_slope 0x08   0x0f
...
static int sensor_init(struct v4l2_subdev *sd, u32 val)
{
    ...
    if(sensor->sensor_gpio_res->gpio_flag & 0x10000)
    {
...
//////////////////
    ...
    if ((int)winseqe_set_addr  != sensor->info_priv.winseqe_cur_addr) {
		...
		if( ((winseqe_set_addr == 640)||(winseqe_set_addr == 480) )||((winseqe_set_addr == 800)||(winseqe_set_addr == 600) ))
			{
                	mdelay(50);//200
