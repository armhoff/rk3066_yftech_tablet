...
#define  SP2518_P0_0xd3  0x70	//0x77 modify by sp_yjp,20121211
#define  SP2518_P0_0xd4  0x6c	//0x77 modify by sp_yjp,20121211
#define  SP2518_P0_0xd6  0x64	//0x77 modify by sp_yjp,20121211
#define  SP2518_P0_0xd7  0x5c	//0x77 modify by sp_yjp,20121211

#define  SP2518_P0_0xd8  0x70	//0x77 modify by sp_yjp,20121211
#define  SP2518_P0_0xd9  0x6c	//0x77 modify by sp_yjp,20121211
#define  SP2518_P0_0xda  0x64	//0x77 modify by sp_yjp,20121211
#define  SP2518_P0_0xdb  0x5c	//0x77 modify by sp_yjp,20121211


//AE
#define  SP2518_P0_0xf7  0x80///0x80//78
#define  SP2518_P0_0xf8  0x74///0x74//6e
#define  SP2518_P0_0xf9  0x80///0x80//74
#define  SP2518_P0_0xfa  0x74///0x74//6a


#define  SP2518_P0_0xec  (SP2518_P0_0xf8-4)///0x80//78
#define  SP2518_P0_0xed  (SP2518_P0_0xf7+6)///0x74//6e
#define  SP2518_P0_0xee  (SP2518_P0_0xfa-4)///0x80//74
#define  SP2518_P0_0xef  (SP2518_P0_0xf9+6)///0x74//6a

//HEQ
#define  SP2518_P0_0xdd  0x80	//0x80 modify by sp_yjp,20120814
#define  SP2518_P0_0xde  0x8c	//0x90 modify by sp_yjp,20120815
...
#define REG_P0_0x31	0x10		//0x70 modify by sp_yjp,20121211
#define BINNING_EN	(1<<3)
#define SUB_EN	(1<<2)
#define V720P_EN	(1<<0)

#define SP2518_FLICK_50HZ 1	  // 1:50HZ  0:60HZ
...
{
	{0xfd , 0x00},
	{0x1b , 0x0a},	//0x02 modify by sp_yjp,20130116
	{0x0e , 0x01},
	{0x0f , 0x2f},
	{0x10 , 0x2e},
	{0x11 , 0x00},
	...
	#if SP2518_FLICK_50HZ
	///SI50_SP2518 UXGA 24MEclk 3PLL 1DIV 50Hz fix 10fps
	///ae setting
	{0xfd , 0x00},
	{0x03 , 0x03},
	{0x04 , 0x90},
	...
	{0xfd , 0x00},
	#else
	///SI50_SP2518 UXGA 24MEclk 3PLL 1DIV 60Hz fix 10fps
	///ae setting
	{0xfd , 0x00},
	{0x03 , 0x02},
	{0x04 , 0xee},
	...
	///{0x0e,0x01},	//del by sp_yjp,20121214
	#endif

	{0xfd,0x01},	//add by sp_yjp for test,20121114
	{0x0f,0x01},	//PCLK DIV 2
	{0xfd,0x00},
	{0x2f,0x08},
...
#else
{
	...
	{0x11,0x00},
	{0x12,0x4f},
	{0x14,0x40},	//0x20 modify by sp_yjp,20121217
	{0x16,0x02},
	{0x17,0x10},
	{0x1a,0x1f},
	{0x1e,0x81},
	...
	{0x26,0x25},
	{0x27,0x6d},
	{0x2c,0x33},	//0x31  modify by sp_yjp,20121217 //0x45 	modify by sp_yjp,20120507
	{0x2d,0x75},
	{0x2e,0x38},//18
	///{0x31,0x10},//mirror upside down
	{0x44,0x03},
	...
	{0xf6,0x38},
	{0xfd,0x01},
	{0x94,0xb0},//f8	//0xc0 modify by sp_yjp,20121214
	{0x95,0x38},
	{0x9c,0x6c},
	{0x9d,0x38},	

	#if 0	//add by sp_yjp,20121214
	///SI50_SP2518 UXGA 24MEclk 2.5PLL 1DIV 50Hz fix 10fps
	///ae setting
	{0xfd , 0x00},
	{0x03 , 0x03},
	{0x04 , 0x48},
	...
	#if 0	//add by sp_yjp,20121214
	///SI50_SP2518 UXGA 24MEclk 3PLL 1DIV 50Hz fix 10fps(param from wxc)
	///ae setting
	{0xfd , 0x00},
	{0x03 , 0x04},
	{0x04 , 0x1a},
	...
	{0xca,0x30},//mean dummy2low
	{0xcb,0x50},//mean low2dummy
	{0xcc,0xb0},//f8;rpc low		//0xc0 modify by sp_yjp,20121214	
	{0xcd,0xb0},//rpc dummy	//0xc0 modify by sp_yjp,20121214
	{0xd5,0x80},//mean normal2dummy
	{0xd6,0x90},//mean dummy2normal
	{0xfd,0x00},  
	...
	{0xb6,0xff},//raw_gflt_fac_outdoor 0x80
	{0xb7,0x80},//60raw_gflt_fac_normal	//0x80	modify by sp_yjp,20121214
	{0xb8,0x40},//40raw_gflt_fac_dummy
	{0xb9,0x20},//raw_gflt_fac_low
	...
	//gamma2
	#if 1	//modify by sp_yjp,20121217
	{0xfd , 0x00},//
	{0x78 , 0x00},////0 //0   
	{0x79 , 0x14},////A //14
	{0x7a , 0x24},////13//24
	...
	//Ytarget 
	{0xfd,0x00},// 
	{0xec,SP2518_P0_0xec},//6a
	{0xed,SP2518_P0_0xed},//7c
	{0xee,SP2518_P0_0xee},//65
	{0xef,SP2518_P0_0xef},//78
	{0xf7,SP2518_P0_0xf7},//78
	{0xf8,SP2518_P0_0xf8},//6e
	{0xf9,SP2518_P0_0xf9},//74
	{0xfa,SP2518_P0_0xfa},//6a 
	//sharpen	  
	{0xfd,0x01},
	{0xdf,0x0f},
	{0xe5,0x10},
	{0xe7,0x10},
	{0xe8,0x28},	//0x20 modify by sp_yjp,20121211
	{0xec,0x28},	//0x20 modify by sp_yjp,20121211
	{0xe9,0x28},	//0x20 modify by sp_yjp,20121211
	{0xed,0x28},	//0x20 modify by sp_yjp,20121211
	{0xea,0x14},	//0x10 modify by sp_yjp,20121211
	{0xef,0x14},	//0x10 modify by sp_yjp,20121211
	{0xeb,0x10},	//0x10 modify by sp_yjp,20121214
	{0xf0,0x10},	//0x10 modify by sp_yjp,20121214
	//;gw
	{0xfd,0x01},//
	{0x70,0x76},//
	{0x7b,0x40},//
...
{
	{0xfd,0x01},	//add by sp_yjp for test,20121117
	{0x0f,0x00},	//PCLK DIV disable
	{0xfd,0x00},
	{0x2f,0x00},
...
/* 720X540 BVGA*/
static struct reginfo sensor_bvga[] =
{	
...
static  struct reginfo sensor_SceneNight[] =
{
	...
	#if SP2518_FLICK_50HZ
	///SI50_SP2518 UXGA 24MEclk 3PLL 1DIV 50Hz fix 6fps
	///ae setting
	{0xfd , 0x00},
	{0x03 , 0x02},
	{0x04 , 0x1c},
	...
	#else
	///SI50_SP2518 UXGA 24MEclk 3PLL 1DIV 60Hz fix 6fps
	///ae setting
	{0xfd , 0x00},
	{0x03 , 0x01},
	{0x04 , 0xc2},
...
static int sensor_s_fmt(struct v4l2_subdev *sd, struct v4l2_mbus_framefmt *mf)
{
	...
	#if 0		//modify by sp_yjp,20121214
/*
    ...
    */
	else if (((set_w <= 720) && (set_h <= 540)) && sensor_bvga[0].reg)
    {
        winseqe_set_addr = sensor_bvga;
        set_w = 720;
        set_h = 540;
    }
